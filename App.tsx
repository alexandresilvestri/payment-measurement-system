...
const ProtectedRoute = ({ children, requiredRole }: { children?: React.ReactNode, requiredRole?: 'DIRETOR' | 'OBRA' }) => {
  ...
  if (requiredRole && currentUser.role !== requiredRole) {
    ...
    return <Navigate to={currentUser.role === 'DIRETOR' ? '/director' : '/site'} replace />;
  }
...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      <Route path="/new-measurement" element={
        <ProtectedRoute>
          <NewMeasurement />
        </ProtectedRoute>
      } />

      <Route path="/realized-measurements" element={
        <ProtectedRoute>
          <RealizedMeasurements />
        </ProtectedRoute>
      } />

      <Route path="/measurement/:id" element={
        <ProtectedRoute>
          <MeasurementDetail />
        </ProtectedRoute>
      } />
